...
method: "POST"
path: "/v1/pixQrCode/creatre"
---

### Authorization

<ParamField path="Authorization" type="header" type="string" required>
...
<ParamField path=" customer" type="object" required>
  Os dados do seu cliente para criá-lo. O objeto de customer não é obrigatório, mas ao informar qualquer informação do `customer` todos os campos `name`, `phone`, `email` e `tax_id` são obrigatórios.
...
<ParamField path="response" type="object">
  ...
  <Accordion title="Child attributes">
    ...
    <ParamField path="amount" type="string">
      ...
      <ParamField path="mathod" type="string">
